...
- 病理學檢驗服務（進階項目）診症費：HK$50／次（無藥費）
- 病理學檢驗服務（高端項目）診症費：HK$200／次（無藥費）
- 非緊急放射科服務（進階項目）診症費：HK$250／次（無藥費）
- 非緊急放射科服務（高端項目）診症費：HK$500／次（無藥費）
...
1. 專科名稱（Text）
2. 服務類型（Select：專科門診 / 普通科門診 / 病理學檢驗服務 / 非緊急放射科服務；預設=專科門診）
3. 服務級別（Select：進階項目 / 高端項目；僅當服務類型為病理學檢驗服務或非緊急放射科服務時顯示）
4. 覆診頻率（Select：本年只覆診一次／1-11 個月）
5. 下次覆診月份（Select：1–12，必填）
6. 藥物數目（Select：0–15，必填；當服務類型為病理學檢驗服務或非緊急放射科服務時隱藏）
7. [Button] 移除
